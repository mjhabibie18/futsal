  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
       ...
       <ol class="breadcrumb">
        <li><a href="<?=site_url('databarang/index')?>"><i class="fa fa-files-o"></i></a></li>
        <li class="active">Data Penjualan</li>
        <li class="active">Form Data Penjualan</li>
      </ol>
    
    <!-- Main content -->
     <?php $this->load->view('_penjualan/tambah_penjualan.php') ?>
