    ...
    <!-- Main content -->
      ...
      <div class="row">
        ...
        <?php endforeach; ?>
          ...
          <form action="<?php echo site_url('datapembelian/prosesretur');?>" method="post" role="form">
            <div class="box-body">
                <div class="form-group">
                  <div class="col-sm-12"> 
                  <label ">Id Retur Pembelian</label>
                 <input type="text" class="form-control input-sm" value="<?=$kode?>" name="id_retur" placeholder="Masukkan Id Retur"  readonly="readonly" style="width: 200px">
                </div>
             <div class="form-group">
                   <div class="col-sm-12"> 
                ...
                <div class="form-group">
                  ...
                  <input type="date" class="form-control input-sm" name="tgl_retur" placeholder="Masukkan Tanggal Transaksi"  style="width: 200px">
                </div>
              </div>
                <div class="form-group">
                  <div class="col-sm-12"> 
                  <label ">Status</label>
                  <Select type="text" class="form-control input-sm" name="status_retur" placeholder="Masukkan Status Retur Pembelian" style="width: 200px">
