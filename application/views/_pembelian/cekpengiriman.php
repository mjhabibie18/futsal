            ...
            <tbody>
              ...
              foreach($datapembelian as $row): ?>
                ...
                <tr>
                  ...
                  <td class="text-left" width="160px"><a href="<?=site_url('datapembelian/tambahstatus/'.$row->kode_pembelian)?>" class="btn btn-primary btn-sm">
                  <i class="fa fa-pencil"></i> Buat Status Pengiriman</a>
                 </tr>
