...
<?php $this->load->view('_layout/sidebar.php') ?>
  ...
  <div class="content-wrapper">
    ...
    {
    echo "<a href='".site_url('datalaporan/addlaporanpembelian')."'>
    <div class='fa fa-plus pull-right btn btn-primary btn-flat'>Tambah Laporan Pembelian</div></a>";
    }
    ?>
              ...
              foreach($laporanpembelian as $row): ?>
                ...
                <tr>
                  ...
                  <td class="text-left" width="160px">
                   <a href="<?=site_url('datalaporan/cetaklaporanpembelian/'.$row->id_laporan)?>" class="btn btn-primary btn-sm">
