...
<?php $this->load->view('_layout/sidebar.php') ?>
  ...
  <section class="content">
    ...
    echo "<input type='hidden' class='pull-right'>";
  	...
  	{
  	echo "<a href='".site_url('datalaporan/addlaporanaruskas')."'>
    <div class='fa fa-plus pull-right btn btn-primary btn-flat'>Tambah Laporan Arus Kas</div></a>";
  	}
  	?>
      <br></br>
              ...
              foreach($laporanaruskas as $row): ?>
                ...
                <tr>
                  ...
                  <td class="text-left" width="160px">
                   <a href="<?=site_url('datalaporan/cetaklaporanaruskas/'.$row->id_laporan)?>" class="btn btn-primary btn-sm">
