...
<?php $this->load->view('_layout/sidebar.php') ?>
  ...
  <section class="content">
    ...
    {
    echo "<a href='".site_url('datalaporan/addlaporanpenjualan')."'>
    <div class='fa fa-plus pull-right btn btn-primary btn-flat'>Tambah Laporan Penjualan</div></a>";
    }
    ?>
      <br></br>
              ...
              foreach($laporanpenjualan as $row): ?>
                ...
                <tr>
                  ...
                  <td class="text-left" width="160px">
                   <a href="<?=site_url('datalaporan/cetaklaporanpenjualan/'.$row->id_laporan)?>" class="btn btn-primary btn-sm">
