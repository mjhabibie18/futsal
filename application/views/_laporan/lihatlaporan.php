...
<?php $this->load->view('_layout/sidebar.php') ?>
  ...
  <section class="content">
      <!-- Info boxes -->
              ...
              <b><a href="<?php echo "laporanpenjualan"; ?>"><span class="info-box-text">Laporan Penjualan</a></b></span>
            </div>
          </div>
        </div>  
        <div class="col-md-4 col-sm-12 col-xs-12">                       
              ...
              <div class="panel-body">
              <i class="fa fa-folder-open fa-5x"></i>
              <b><a href="<?php echo "laporanpembelian"; ?>"><span class="info-box-text">Laporan Pembelian</a></b></span>
            </div>
          </div>
        </div> 
        <div class="col-md-4 col-sm-12 col-xs-12">                       
              ...
              <div class="panel-body">
              <i class="fa fa-folder-open fa-5x"></i>
              <b><a href="<?php echo "laporanaruskas"; ?>"><span class="info-box-text">Laporan Arus Kas Harian</a></b></span>
            </div>
          </div>
        </div> 
         <div class="col-md-4 col-sm-12 col-xs-12">                       
              ...
              <div class="panel-body">
              <i class="fa fa-folder-open fa-5x"></i>
              <b><a href="<?php echo "laporanpendapatan"; ?>"><span class="info-box-text">Total Pendapatan</a></b></span>
            </div>
          </div>
        </div>     
   </div>
